...
<form action="<s:url namespace="/user" action="checkUUID"/>" method="post">
    <div class="validate_email">
        ...
        <div class="look_email">
            ...
            <div class="mess reduce_h">
                我们给您发送了验证邮件，邮件地址为：
                <span class="red"><span id="lblEmail"><s:property value="user.email"/></span></span>
                <span class="t1">请登录您的邮箱收信。</span>
                <span class="t1"><s:property value="uuid"/></span>
            ...
            <div class="mess">
                ...
                <input name="typeUUID" type="text" id="validatecode" class="yzm_text"/>
